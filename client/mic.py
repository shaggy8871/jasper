...
class Mic:
    ...
    def activeListenToAllOptions(self, THRESHOLD=None, LISTEN=True,
        ...
        CHUNK = 1024
        LISTEN_TIME = 12
        WAIT_TIME = 45 # waits 3-4 seconds before testing for average threshold
        ...
        for i in range(0, RATE / CHUNK * LISTEN_TIME):
            ...
            # TODO: 45 is arbitary but seems to prevent premature response    
            if i > WAIT_TIME and average < THRESHOLD * 0.8:
                break
